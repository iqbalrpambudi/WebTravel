<!-- Tambah Paket Modal -->
<div class="modal fade" id="TambahPaketRohaniModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Tambah Data Paket Rohani</h5>
				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
			<div class="modal-body">
				<form action="tambahpaketrohani" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="EditPaketRohaniModal<?= $pkt['id']?>" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="updatepaketrohani/<?= $pkt['id']?>" method="post">
					<div class="form-group">
...
<!-- Hapus paket Rohani Modal -->
<?php foreach($rohani as $pkt):?>
<div class="modal fade" id="HapusPaketRohaniModal<?= $pkt['id']?>" tabindex="-1" role="dialog"
	aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="<?= base_url()?>admin/hapuspaketrohani/<?= $pkt['id']?>">Hapus</a>
			</div>
		</div>
	</div>
</div>
